...
def set_layout():
    ...
    translation_board = Text(editor, height=55, width=80, name="translation_board")
    translation_board.grid(row=2, column=0, rowspan=5)

    editing_board = Text(editor, height=55, width=80, name="editing_board")
